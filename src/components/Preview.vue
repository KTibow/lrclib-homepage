<template>
  <dialog ref="dialogRef" class="bg-transparent max-w-screen-sm mx-2" @click="onBackdropClick">
    <div class="w-full max-w-screen-sm rounded-lg bg-white flex flex-col gap-2">
